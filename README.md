...
![esbuild](https://img.shields.io/badge/esbuild-0.27-ffcf00?logo=esbuild&logoColor=black)
...
Uses TypeScript in strict mode with esbuild for fast bundling and watch mode. Code quality is handled by ESLint and Prettier. Environment variables are managed through dotenv.
...
| `npm run build` | Type-check, lint, and bundle for production |
